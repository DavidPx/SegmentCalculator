 ...
 * lead to a {@link DesignDetailActivity} representing
...
public class DesignListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View recyclerView = findViewById(R.id.design_list);
    ...
    public class SimpleItemRecyclerViewAdapter
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.design_list_content, parent, false);
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putString(DesignDetailFragment.ARG_ITEM_ID, holder.mItem.id);
                        ...
                        intent.putExtra(DesignDetailFragment.ARG_ITEM_ID, holder.mItem.id);
